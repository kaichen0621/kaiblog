---
slug: app
title: 📱 KAI macOS 電腦裡有什麼
date: 2026-06-29T08:00
description: "我的 Mac 軟體清單"
tags: []
---
...
13. Dorico : 最近想刪除的打譜軟體，超級難用，還是喜歡 musescore
14. Final Cut Pro : 剪輯簡單快速影片時很好用、有效率！但是我不太會用
15. Finale 27 : 停止提供更新了，最近沒什麼在用
16. Gemini : 那個… 要 AI 得時候挺方便的，而且很快速 (我設定 按右邊兩下 command)
...
22. iZotope RX 12 : 處理人聲超級好用的工具，最近砸到第12版了
23. Keka : 超好用壓縮工具！RAR 打得開～
24. Keynote : 蘋果簡報工具
25. Kontakt 8 : 強大的採樣音源主機
26. Line : 必要但笨重的通訊軟體
...
34. MilkyTracker : 離線時肯定好用的取樣 / 編曲工具！
35. Motrix : 免費速度快得下載器
36. Musescore 4 : 開源打譜軟體
37. Native Access : 官方的入庫管理工具
38. Numbers : 蘋果表格工具
39. OBS : 強大的開源螢幕錄影與直播軟體
40. Ollama : 在荒島時可用的離線 AI 工具，前提是電腦配置要好 …
41. OpenBVE : 開源模擬駕駛遊戲，最近跳轉到 BVE6 真開心
42. Pages : 蘋果文件排版工具
43. Parallels Desktop : Windows 虛擬機，效能強大
44. Pearcleaner : 乾淨卸載 App 的利器
45. Raycast Beta : 至少比 Spolight 好用，Beta 版功能強大 / 搜尋檔案好用
46. Roblox : 我唯一玩的遊戲
47. Steinberg Library Manager : 管理 VST 音色庫路徑與授權的工具
48. Syncthing : 超好用的同步工具，最近在學習如何使用 (建議搭配 Obsidian)
49. Vorssaint : 開源強大的工具彙整工具，只能說太強大了
50. Vovious : 調音準很方便，媲美 Melodyne
51. VSCodium : 還是開源的文字編輯器好用